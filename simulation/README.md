...
**NOTE #1:** Data were simulated using Hidden Semi-Markov Models and with the covariance matrix derived from the real data (see `sim_cov.npy`).

**NOTE #2:** DyNeStE and the HMM used the same random seed for each simulation run.

"""Run HMM on the Nottingham MEGUK dataset."""
...
if __name__ == "__main__":
    ...
    SAVE_DIR = os.path.join(BASE_DIR, f"results/{data_type}/hmm/run{run_id}")
    ...
    training_data = Data(
        file_names,
        store_dir=f"tmp_{data_type}_hmm_{run_id}",
    )
    ...
    alphas = model.get_alpha(training_data)  # equivalent to HMM gammas

    # Get transition probabilities
    tp = model.get_trans_prob()
